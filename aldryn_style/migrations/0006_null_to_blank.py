...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for obj in orm['aldryn_style.style'].objects.all():
            if not obj.id_name:
                obj.id_name = ''
    ...
    models = {
        u'aldryn_style.style': {
            ...
            'class_name': ('django.db.models.fields.CharField', [], {'default': "'container'", 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'id_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
