...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('aldryn_style', 'padding_left',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Style.padding_right'
        db.add_column('aldryn_style', 'padding_right',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Style.padding_top'
        db.add_column('aldryn_style', 'padding_top',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Style.padding_bottom'
        db.add_column('aldryn_style', 'padding_bottom',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Style.margin_left'
        db.add_column('aldryn_style', 'margin_left',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Style.margin_right'
        db.add_column('aldryn_style', 'margin_right',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Style.margin_top'
        db.add_column('aldryn_style', 'margin_top',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Style.margin_bottom'
        db.add_column('aldryn_style', 'margin_bottom',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Style.class_name'
        db.alter_column('aldryn_style', 'class_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):
        # Deleting field 'Style.padding_left'
        db.delete_column('aldryn_style', 'padding_left')

        # Deleting field 'Style.padding_right'
        db.delete_column('aldryn_style', 'padding_right')

        # Deleting field 'Style.padding_top'
        db.delete_column('aldryn_style', 'padding_top')

        # Deleting field 'Style.padding_bottom'
        db.delete_column('aldryn_style', 'padding_bottom')

        # Deleting field 'Style.margin_left'
        db.delete_column('aldryn_style', 'margin_left')

        # Deleting field 'Style.margin_right'
        db.delete_column('aldryn_style', 'margin_right')

        # Deleting field 'Style.margin_top'
        db.delete_column('aldryn_style', 'margin_top')

        # Deleting field 'Style.margin_bottom'
        db.delete_column('aldryn_style', 'margin_bottom')


        # Changing field 'Style.class_name'
        db.alter_column('aldryn_style', 'class_name', self.gf('django.db.models.fields.CharField')(max_length=50))
