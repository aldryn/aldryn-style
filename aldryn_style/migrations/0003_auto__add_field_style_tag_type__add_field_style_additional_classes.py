...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'aldryn_style', 'tag_type')

        # Deleting field 'Style.additional_classes'
        db.delete_column(u'aldryn_style', 'additional_classes')
    ...
    models = {
        ...
        u'aldryn_style.style': {
            'Meta': {'object_name': 'Style', 'db_table': "u'aldryn_style'", '_ormbases': ['cms.CMSPlugin']},
